class script(object):
    START_TXT = """<b> 👋 ʜᴇʟᴏ {},
 ᴍy ɴᴀᴍᴇ ɪꜱ <a href=https://t.me/{}>{}</a>,\n ɪᴀᴍ ᴀ ᴩʀᴇ ꜰᴜɴᴄᴛɪᴏɴᴇᴅ ᴀᴜᴛᴏꜰɪʟᴛᴇʀ & ᴩᴜʙʟɪᴄ ʙᴏᴛ ꜱᴏ yᴏᴜ ᴄᴀɴ ᴀᴅᴅ ᴍᴇ ᴛᴏ yᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴩ ᴀɴᴅ ᴍᴀᴋᴇ ᴍᴇ ᴀꜱ ᴀᴅᴍɪɴ ...</b>"""
    HELP_TXT = """𝙷𝙴𝚈 {}
ʜᴇʟᴩ ᴄᴏᴍᴍᴀɴᴅꜱ """
    ABOUT_TXT = """✯ ᴍy ɴᴀᴍᴇ ᴛᴏᴠɪɴᴏ ᴠ9
...
❍ ʟᴀꜱᴛ ᴜᴩᴅᴀᴛᴇ  ➪ 31 𝑴𝒂𝒚"""
    SOURCE_TXT = """<b>ɴᴏᴛᴇ</b>
- ᴛᴏᴠɪɴᴏ ᴠ9 ɪꜱ ɴᴏᴛ ᴀ ᴏᴩᴇɴ ꜱᴏᴜᴄʀᴇ ʙᴏᴛ (ʀᴇᴩᴏ ɪꜱ ᴩʀɪᴠᴀᴛᴇ) 
